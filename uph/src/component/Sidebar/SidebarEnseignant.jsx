...
const navigationItems = [
  { icon: LayoutDashboard, label: "Tableau de bord", path: "/Enseignant" },
  { icon: Users, label: "Gestion utilisateurs", path: "/Notes" },
  { icon: GraduationCap, label: "Gestion étudiants", path: "/Cours" },
  { icon: Briefcase, label: "Gestion enseignants", path: "/Presence" }
];

export const SidebarEnseignant = () => {
  return (
    <div className="h-screen w-64 bg-gray-900 text-white flex flex-col fixed top-0 left-0 border-r border-gray-800">
      ...
      <div className="px-6 py-6 border-b border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-sm font-bold text-amber-500">Prof Panel</h1>
